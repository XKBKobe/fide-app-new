...
public class BaiduLocationPlugin extends CordovaPlugin  implements BDLocationListener {
    ...
    JSONObject addressComponents = new JSONObject();
    ...
    public void onReceiveLocation(BDLocation location) {
        try {
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation){// GPS定位结果
                ...
                addressComponents.put("province", location.getProvince());
                addressComponents.put("city", location.getCity());
                addressComponents.put("district", location.getDistrict());
                addressComponents.put("street", location.getStreet());
                addressComponents.put("streetNumber", location.getStreetNumber());
                addrInfo.put("addressComponents", addressComponents);
            ...
            if(mWatchCallback!=null){
                mWatchCallback.success(addrInfo);
            }
    ...
    public boolean execute(String action, JSONArray inputs, CallbackContext callbackContext) throws JSONException {
        try {
            if ("getLocation".equals(action)) {
                mWatchCallback = callbackContext;
                if(!hasPermisssion()){
