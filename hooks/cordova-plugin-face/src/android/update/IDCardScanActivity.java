...
public class IDCardScanActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private void init() {
        ...
        mIdCardIndicator = (IDCardIndicatorView) findViewById(R.id.idcardscan_layout_indicator);
    ...
    private class DecodeThread extends Thread {
        ...
        private void handleSuccess(IDCardQualityResult result) {
            ...
            //xkb update callback
            String idCardImgBase64 = new IFile().byte2base64(Util.bmp2byteArr(result.croppedImageOfIDCard()));
            String portraitImgBase64 = "";
            if (null != result.croppedImageOfPortrait()) {
                portraitImgBase64 = new IFile().byte2base64(Util.bmp2byteArr(result.croppedImageOfPortrait()));
            }

            JSONObject jsonObject = new JSONObject();
            try {
                jsonObject.put("idCardImgBase64", idCardImgBase64);
                jsonObject.put("portraitImgBase64", portraitImgBase64);
