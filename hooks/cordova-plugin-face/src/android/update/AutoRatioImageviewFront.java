...
public class AutoRatioImageviewFront extends ImageView {
    private float mRatio = -1;
    private int mPrefer = 0;

    public AutoRatioImageviewFront(Context context) {
        super(context);
    }

    public AutoRatioImageviewFront(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public AutoRatioImageviewFront(Context context, AttributeSet attrs, int defStyle) {
