...
public class IDCardIndicatorView extends View {
    ...
    public void setBackColor(Activity activity, int backColor) {
        if (this.backColor != backColor) {
            ...
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    IDCardIndicatorView.this.invalidate();
                }
            });
        }
    }
    ...
    public IDCardIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public IDCardIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
